...
import {
  ...
  //sendPresentationToDevice,
  sendPresentationToDeviceForNormal,
  sendPresentationToDeviceForAngularReplacement,
...
import { DeviceSelection, Modetype } from '@app/src/components/Selection/DeviceSelection';
...
import * as S from './PresentationSendDialog.style';
...
export function PresentationSendDialog(props: SettingProps) {
      ...
      <DeviceSelection
        ...
        onSelect={async (devices: DevicesAPIDeviceResult[]) => {
          try {
            ...
            //sendPresentationToDeviceForAngularReplacement
            //sendPresentationToDevice -> 이거 안 쓰는 듯
            //sendPresentationToDeviceForNormal
            await sendPresentationToDeviceForNormal(
              deviceIds,
              presentation,
              content.startDate,
              content.endDate,
            ...
            modalCtrl.open(<Alert text='콘텐츠 전송에 실패하였습니다.' />);
          }
        }}
      />
    );
