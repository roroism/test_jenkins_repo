...
import { RemoteVideoObject } from '@app/src/pages/LayoutEditor/lib/objects/fabric.video';
...
export function RemoteVideoSubPanel(props: PanelProps) {
  ...
  const startDrag = (e: React.DragEvent<HTMLImageElement>, asset: Asset) => {
    ...
    const object = new RemoteVideoObject(e.currentTarget).apply('srcLink', asset.srcLink);
