...
import { SDSSVideoObject } from '@app/src/pages/LayoutEditor/lib/objects/fabric.video';
...
export function SDSSVideoSubPanel(props: PanelProps) {
  ...
  const startDrag = (e: React.DragEvent<HTMLImageElement>, asset: Asset) => {
    ...
    const object = new SDSSVideoObject(e.currentTarget)
      .apply('id', asset.id)
