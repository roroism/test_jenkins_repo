...
import { SDSSImageObject } from '@app/src/pages/LayoutEditor/lib/objects/fabric.image';
...
export function SDSSImageSubPanel(props: PanelProps) {
  ...
  const startDrag = (e: React.DragEvent<HTMLImageElement>, asset: Asset) => {
    ...
    const object = new SDSSImageObject(e.currentTarget)
      .apply('name', asset.name)
      .apply('id', asset.id)
      .apply('fileType', asset.fileType)
      .apply('md5', asset.md5)
      .apply('mimeType', asset.mimeType);
